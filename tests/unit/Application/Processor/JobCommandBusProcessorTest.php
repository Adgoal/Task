...
namespace AdgoalCommon\Task\Tests\Unit\Application\Processor;
...
use AdgoalCommon\Task\Application\Processor\JobCommandBusProcessor;
use AdgoalCommon\Task\Infrastructure\Service\Test\JobRunner;
...
class JobCommandBusProcessorTest extends TestCase
{
     ...
     * @group unit
     *
     * @dataProvider \AdgoalCommon\Task\Tests\Unit\DataProvider\TaskDataProvider::getData
     *
     ...
     *
     * @return MockInterface|CommandBus
     */
     ...
     * @param int           $times
     *
     * @return MockInterface|CommandFactoryInterface
     */
